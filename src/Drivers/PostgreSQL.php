...
class PostgreSQL extends Dbms
{
    ...
    private static $tomany_foreign_queries = 'select distinct ra.ordinal, rn.nspname schema_name, rt.relname table_name, ra.attname column_name, c.conname "name", n.nspname foreign_schema_name, t.relname foreign_table_name, a.attname foreign_column_name '.
